...
const Navbar = () => {
    return (
        <>
            <div className='w-full flex h-[4rem] text-lg text-white bg-lime-500 font-serif shadow-sm shadow-black'>
                <div className='w-[50%] flex flex-row h-full items-center ml-10 justify-center text-xl'><div className="w-30 h-30 p-3 rounded-sm shadow-md shadow-black bg-lime-500">Jagadheesh B</div></div>
